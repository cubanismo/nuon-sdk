...
;
; ENTRY POINTS:
; __fix_sincos: returns sin and cos of r0 in r1 and r0, respectively, as 2.30 numbers
; _FixSinCos:  puts sin and cos of r0 in memory locations pointed to by r1 and r2;
;              they are left as 2.30 numbers
;
...
;
	...
	.export _FixSinCos
_FixSinCos:
	ld_io	rz,r8			; save our return address
	jsr	__fix_sincos
	copy	r1,r9			; save pointers to output
	copy	r2,r10

{	jmp	(r8)			; return to caller (r8 contains old rz)
}
{	st_s	r1,(r9)			; store sin
}
{	st_s	r0,(r10)		; store cos
	copy	r1,r0			; return the sine
}
...
{	bra	eq,rightAngle,nop	; jump if exact right angle
