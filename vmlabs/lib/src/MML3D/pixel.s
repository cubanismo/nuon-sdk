...
{	st_s	r3,_DS_curtexture
	...
	mv_s	#perpoly_init - _pixel_init,r1
	add	r1,r0
...
use_this:	
	...
	lsr	#4,r2
	and	#15,r2			; extract pixel write mode (0 == 4bpp, 2 == 16bpp, 4 == 32bpp)
	asl	#20,r2			; put it in the uvctl place
//	or	#(1<<28)|(12<<12)|(12<<16),r2	; set chnorm bit, mask bits for max. 16x16 texture
...
{	bra	le,`use_r2r3,nop
	add	#3,r0		; make 8 the default size
}
{	bra	ge,`bigger_than_0,nop
	...
	mv_s	#0,r0
`bigger_than_0:
	cmp	#5,r0		; make sure cache width will be <= 32
{	bra	le,`smaller_than_5,nop
...
`size_ok:
{	sub	#5,r0,r1	; set v_size = -(5 - u_size) = u_size - 5
	mv_s	#1,r2
}
...
{	not	r1
	...
	pop	_D_VTRI
	rts
	add	#specpix - perpoly_init,r0
	nop

	;; special case solid color initialization code
	;; enter with r1 == 24 bit YCC color
solid_poly_init:
...
solidspecpix:
	...
	sub	_D_i1,const_one,shade	; set shade = (1.0 - specular)
...
`ltdone:
	ld_s	mdmactl,r0		; wait DMA to complete
	nop
	bits	#4,>>#0,r0
	bra	ne,`ltdone,nop
