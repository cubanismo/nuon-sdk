 ...
 * RGB0555 Video Transparency Flag is set. If color == trans set pixel to 0,0,0
 */
#include "pixmacro.h"
/* Ideally, the ColCvrt0RGB16 function would be inline.  But it uses
...
mrpStatus copUns0RGB16Vid(BiCopyParamBlock* par, indexBlock* indexInP, indexBlock* indexOutP,
	odmaCmdBlock* odmaP, mdmaCmdBlock* mdmaP, int transColor )
{
