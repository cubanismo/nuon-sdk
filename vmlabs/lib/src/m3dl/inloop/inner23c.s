/*
 * Title	INNER23C.S
 * Description	MPR Inner Loop 23C
 * Version	1.0
 * Start Date	12/31/98
...
*/
	...
	.export _inn23C_start, _inn23C_size
...
MPR_inn23C:
	...
	mv_s	#1<<29,_DGRBA[1]		;CHNorm Value
       }
       {
	sub	v3[3],#fix(2,iprec),v3[3] 	;2 - z*RecipLut value
	mv_s	_DGRBA[1],_DGRBA[2]		;CHNorm Value
       }
       {
