...
/*      #define HS_BUILD_FOR_UNIX                1                */
        #define HS_BUILD_FOR_NUON                1                /* VML_JS */
...
#define HS_CAN_USE_FLOAT                                        0
#define HS_SCALAR_IS_FLOAT                                      0

#define HS_IMPULSE_SUPPORT_DEVICE32                     0
#define HS_IMPULSE_SUPPORT_DEVICE16                     1
#define HS_IMPULSE_SUPPORT_NUON655                      0 
...
#define HS_IMPULSE_SUPPORT_SQUAREPEN            0




// Only permit Windows fonts if building in Win32 
#if !defined(WIN32) && defined(HS_BUILD_FOR_NUON)
#ifndef NUON_NATIVE_FONTS
#define NUON_NATIVE_FONTS
#endif // NUON_NATIVE_FONTS
#endif // WIN32
