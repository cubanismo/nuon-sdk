...
#define GL_TEXTURE_1D_BINDING             0x8068
...
#define GL_CHROMAKEY_EXT                  0x0DF5

// Texture format extensions
#define GL_COLOR_INDEX4_EXT               0x80E4
#define GL_COLOR_INDEX8_EXT               0x80E5
#define GL_YCC_EXT                        0x80E6
#define GL_YCC16_EXT                      0x80E7
#define GL_YCCZ_EXT                       0x80E8
#define GL_YCC16Z_EXT                     0x80E9
#define GL_MPEG_EXT                       0x80EA
#define GL_RGBZ_EXT                       0x80EB
#define GL_RGB16Z_EXT                     0x80EC

#define VERTEX_XYZWUVN          0   // x, y, z, w, u, v are scalars; nx, ny, nz are shorts, last short is wasted
#define VERTEX_XYZC             1   // x, y, z are scalars; G, R, B, A are packed together into a scalar
#define VERTEX_XYZN             2   // x, y, z are scalars; nx, ny, nz are packed together into a scalar
#define VERTEX_FORMAT_COUNT     3

// fixed-point defines
#define GLXYZWMODELSHIFT        10
#define GLTRIGSHIFT             14
#define GLNORMALSHIFT           14
#define GLTEXCOORDSHIFT         18
...
struct GLTEXTURESTRUCTURE {
    GLuint width;           // Texture width
    GLuint height;          // Texture height
    GLuint size;            // Size in long words
    GLuint pixelType;       // Pixel type
    GLuint *pbuffer;        // Pixel buffer pointer
    GLuint *clut;           // Pointer to CLUT, or NULL
    GLuint clutSize;        // CLUT size in long words (since CLUT entries are either e888Alpha or eGRB888Alpha,
                            // this is equivalent to the maximum number of CLUT entries)
    GLuint mpeInfo[3];      // parameters passed to rendering MPEs
    GLuint dCacheSync;      // nonzero if we need to call _DCacheSync() before downloading to rendering MPEs
};

typedef struct GLTEXTURESTRUCTURE GLTexture;

// API prototypes in alphabetical order
...
// Merlin Extensions
void glLoadMatrixfpExt(const GLint *m);
...
void mglWaitForMPEs(GLbitfield);

// Implemented GL Utilities Library procedures
