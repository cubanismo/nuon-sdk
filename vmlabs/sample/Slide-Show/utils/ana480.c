...
// 10/7/01 changing STD_BORDER to 24 for better empirical result
/*
    Do the anamorphic fix from an arbitrary W by H image into
    720 by 480, with an eight-pixel border at each side.
...
#include <ctype.h>
#include "image.h"
#define STD_WIDTH  720
#define STD_HEIGHT 480
//#define STD_BORDER 8
#define STD_BORDER 24
