...
struct tagTestSetup {
	...
	FontFileBlock **fontFiles;

	// used for Nuon -- load fonts already allocated in memory
	FontRamBlock **fontRamBlks;

	// number of fonts to set up before test begins (others added as needed)
	int numDefaultFonts;
};
...
void DrawUnicodeCaption( NuonRaster *nr, TestSetup *pts);
