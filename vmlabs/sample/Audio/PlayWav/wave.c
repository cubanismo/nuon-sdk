...
////////////////////////////////////////////////////////////////////////////
// Play a couple of WAV sound files and a couple of AIFF sound files
////////////////////////////////////////////////////////////////////////////

int main()
{
int i, voice1, voice2, voice3, voice4;
PCMPOS Pan;
	...
	for( i = 0; i < 3; i++ )
	{
		voice1 = PlayWAV((void *)Sample1, -1, &Pan, 0x40000000, 0x40000000 );
		_VidSync(360);
		
		voice2 = PlayWAV((void *)Sample2, -1, &Pan, 0x40000000, 0x40000000 );
		_VidSync(360);
		
		voice3 = PlayAIFF((void *)Sample3, -1, &Pan, 0x40000000, 0x40000000 );
		_VidSync(360);
		
		voice4 = PlayAIFF((void *)Sample4, -1, &Pan, 0x40000000, 0x40000000 );
		_VidSync(360);
	}
