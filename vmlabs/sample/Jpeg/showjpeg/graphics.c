...
////////////////////////////////////////////////////////////////////////////
// picture = pointer (long aligned) to source image data (32-bit)
// xoff & yoff = Destination screen target position
// imgwid & imght = Source image size
// wclip & hclip = maximum source coordinates for drawing image
////////////////////////////////////////////////////////////////////////////

#define DMA_SEGMENT_LENGTH	(64)	// Presumes that 1 pixel = 1 longword
...
int readflags;
	...
	for( yy = 0; yy < hclip; yy++ )
	{
		...
		// With a "long" pointer, this assumes that the pixels are 32-bit
		theScanline += imgwid;
	}
}
